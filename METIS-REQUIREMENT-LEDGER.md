...
transitions nothing writes one of its own. A requirement moves to Verified only when a named test run or
observed behavior proves it — never because a document mentions it.

Last reviewed: 2026-08-02 · Repository state at review: build-order step 7
